            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-purple-50 py-5 rounded-xl border border-purple-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-violet-500"><span className=" font-bold">Name :</span> Kamal Nayan Upadhyay</h1>
                            <h1 className=" text-center text-lg text-violet-500"><span className=" font-bold">Email :</span> test@gmail.com</h1>
                        </div>
                    </div>
                </div>
